...
# Short bio (displayed in userasdqwe profile at end of posts)
bio: 
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:riverrsea@outlook.com'  # For a direct email link, use "mailto:test@example.org".
- icon: github
  icon_pack: fab
  link: https://github.com/riverrsea
